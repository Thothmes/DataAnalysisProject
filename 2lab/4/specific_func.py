        ...
        for minus_sum_by_name in minus_sum_by_names:
            ...
            if minus_sum_by_name[1] != 0:
                ...
                if plus_sum_by_name[1] >= abs(minus_sum_by_name[1]):
                    transactions.append(
                        [plus_sum_by_name[0], minus_sum_by_name[0], round((plus_sum_by_name[1] - minus_sum_by_name[1]),2)])
                    ...
                    transactions.append(
                        [plus_sum_by_name[0], minus_sum_by_name[0], round((abs(minus_sum_by_name[1]) - plus_sum_by_name[1]),2)])
